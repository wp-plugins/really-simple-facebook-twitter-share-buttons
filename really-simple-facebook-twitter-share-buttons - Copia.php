...
function really_simple_share ($content, $filter, $link='', $title='') {
	...
	$tags = 'x';
	$language = 'it_IT';
<div class="wp-flattr-button"><a class="FlattrButton" style="display:none;" href="'.$link.'" title="'.$title.'" rev="flattr;uid:'.$uid.';language:'.$language.';category:text;tags:'.$tags.';button:compact;">'
.strip_tags($testo_completo).'</a></div>
	*/
